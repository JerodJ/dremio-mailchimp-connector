...
@SourceType(value = "MailChimpARP", label = "MailChimp",uiConfig = "mailchimp-layout.json")
public class MailChimpConf extends AbstractArpConf<MailChimpConf> {
  private static final String ARP_FILENAME = "arp/implementation/mailchimp-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.mailchimp.MailChimpDriver";
